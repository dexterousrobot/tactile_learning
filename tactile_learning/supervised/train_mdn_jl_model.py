...
def train_mdn_jl_model(
    ...
    if init_dir is not None:
        model.load_state_dict(torch.load(os.path.join(init_dir, 'best_model.pth')))
    ...
    step_size = learning_params['cyclic_half_period'] * n_train_batches
